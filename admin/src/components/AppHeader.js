    ...
    <CHeader position="sticky" className="mb-4 p-0" ref={headerRef}>
      <CContainer className="border-bottom px-4" fluid>
        ...
        <CHeaderNav className="ms-auto">
            ...
            <CDropdownToggle placement="bottom-end" className="py-0 pe-0" caret={false}>
              <CNavItem>
                <div style={{ position: 'relative' }}>
                  ...
                  {notificationCount > 0 && (
                    <CBadge color="danger" className="ms-2" style={{ position: 'absolute', top: '-8px', right: '-8px' }} textColor="white">
                      {notificationCount}
                    </CBadge>
                  )}
                </div>
            ...
            <CDropdownMenu className="pt-0" placement="bottom-end" onClick={handleDeleteNotification} style={{ maxHeight: '300px', overflowY: 'auto', cursor: 'pointer' }}>
