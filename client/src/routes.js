...
const routes = [
  ...
  { path: '/transactionhistory', name: 'Transaction History', element: TH },
  { path: '/billrecords', name: 'Bill Records', element: Billrecords },
  { path: '/onlinepayment', name: 'Payment', element: Onlinepayment },
